...
export const useMovie = (identifier: number | string) =>
  useQuery({
    ...
    queryFn: () => {
      ...
      const isNumbericOnly = /^\d+$/.test(String(identifier))

      return isNumbericOnly
    ...
    // By default, React Query will execute the query function as soon as the component mounts.
...
export const useUpdateMovie = () => {
  ...
  // note: react query expects a single argument to the mutationFn
  return useMutation({
    mutationFn: ({
      id,
      movie,
